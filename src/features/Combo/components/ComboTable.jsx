      ...
      <tbody className="bg-white divide-y divide-gray-200">
        {comboList?.map((combo) => (
          <tr key={combo._id}>
            ...
            <td className="px-6 py-4  max-w-xs">
              <div className="text-sm text-right capitalize text-yellow-600">{combo?.total}</div>
            </td>
            <td className="px-6 py-4  max-w-xs">
              <div className="text-sm text-right capitalize text-blue-500">{combo?.lastPrice}</div>
            </td>
